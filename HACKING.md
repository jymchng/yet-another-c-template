...
hidden if the `c_template_two_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `c_template_two_DEVELOPER_MODE` to the configure
...
Runs the executable target `c_template_two_exe`.

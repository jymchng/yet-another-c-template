...
message(STATUS "[INFO] `bin` = ${bin}")
message(STATUS "[INFO] `src` = ${src}")
...
# The aim is to obtain the entire
# ~~~
# project (
# PROJECT_NAME ... ...
# )
# ~~~
# call out from your `${src}/CMakeLists.txt` file

file(READ "${src}/CMakeLists.txt" content)
message(STATUS "[INFO] `\${src}/CMakeLists.txt` = ${src}/CMakeLists.txt")
...
# MESSAGE(STATUS "[INFO] `\${content}` = ${content}")
